...
const items = [
  {
    ...
    href: 'https://x.com/alfredo_mtzrmz',
  },
  {
    title: 'Alfredo GitHub',
    icon: `mdi-github`,
    href: 'https://github.com/alfredomtzrmz',
  },
  {
    title: 'Alfredo Linkedin',
    icon: `mdi-linkedin`,
    href: 'https://www.linkedin.com/in/alfredomtzrmz/',
  },
  {
    title: 'Alfredo CV',
    icon: `mdi-file-document-outline`,
    href: 'https://cv.alfredom.dev/',
  },
];
</script>
